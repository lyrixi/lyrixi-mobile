...
import type { TabBarDemoGroupItemArg } from './TabBar.demos.types'
...
export default () => {
  ...
  const [value, setValue] = useState<TabBarDemoGroupItemArg>({ name: 'Vegetable', id: 'Vegetable' })

  function handleChange(next: TabBarDemoGroupItemArg) {
    setValue(next)
  }
  return (
    <Page>
