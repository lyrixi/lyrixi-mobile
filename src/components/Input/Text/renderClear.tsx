...
import type { InputTextRenderClearParams } from '../types'
...
// 渲染清除按钮
function renderClear({ clearRender, allowClear, value, onClear, onTouchStart }: InputTextRenderClearParams): React.ReactNode {
