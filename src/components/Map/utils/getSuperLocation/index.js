    ...
    onError: (res) => {
        ...
        onError &&
          onError({
            ...
            message: LocaleUtil.locale(
              '未开启定位服务或权限，定位失败',
              'lyrixi_95491614e045ef613a2a90b6f0a162f1'
            )
          })
        return
      }
      if (
        ...
        onError &&
          onError({
            ...
            message: LocaleUtil.locale(
              '网络异常，定位失败',
              'lyrixi_31208a8ed1bbb2f00cea08335add57e3'
            )
          })
        return
      }
      ...
      onError &&
        onError({
          ...
          message: LocaleUtil.locale('网络异常，定位失败', 'lyrixi_31208a8ed1bbb2f00cea08335add57e3')
        })
    }
  }
  // 立即定位
