...
| title          | 标题           | `ReactNode`                                            | -                            |
| headerRender   | 自定义头部渲染 | `(props: { open, onClick }) => ReactNode`              | -                            |
| ellipsis       | 省略配置       | `{ expandText?: ReactNode, collapseText?: ReactNode }` | -                            |
| ellipsisRender | 自定义省略渲染 | `(props: { open, onClick }) => ReactNode`              | -                            |
