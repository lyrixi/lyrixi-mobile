...
**约束：** 遵守 [`.ai/rules/develop-page-structure.md`](../../rules/develop-page-structure.md)、`develop-sequence-import.md`、`develop-locale.md`。生成代码时**不要修改** `.ai/rules/`。
...
后缀用 `Edit`。见 `develop-page-structure.md`。
