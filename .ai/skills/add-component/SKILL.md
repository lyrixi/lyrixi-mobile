...
3. Read [`.ai/rules/component-structure.md`](../../rules/component-structure.md) — 形态 A/B/C 与组件包目录。
...
**问题：** 新组件属于哪种包形态？（见 `component-structure`）
...
- 组件包（结构见 `component-structure`）— 实现、类型、样式、`component-spec.json`
- 库导出入口 — 新增 `export`
