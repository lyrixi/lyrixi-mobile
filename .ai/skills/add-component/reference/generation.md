...
1. **类型** — `types/{Name}.types.ts`（+ 子组件类型、`.modules.types.ts`）；遵守 [global-coding-structure-types.md](../../../rules/global-coding-structure-types.md)、[global-coding-types.md](../../../rules/global-coding-types.md)。
